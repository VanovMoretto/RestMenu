...
export const menuItems: Record<string, MenuItemType[]> = {
  entrada: [
    ...
    { id: 'c1', name: 'items.c1.name', description: 'items.c1.desc', price: prices.couvert_dadinhos, image: 'pratos/dadinhos.png' },
    { id: 'c2', name: 'items.c2.name', description: 'items.c2.desc', price: prices.couvert_croquetas, image: 'pratos/croquetas.png' },
    { id: 'c3', name: 'items.c3.name', description: 'items.c3.desc', price: prices.couvert_polenta, image: 'pratos/polenta.png' },
    { id: 'c4', name: 'items.c4.name', description: 'items.c4.desc', price: prices.couvert_batatinha, image: 'pratos/batatinha.png' },
    { id: 'c5', name: 'items.c5.name', description: 'items.c5.desc', price: prices.couvert_iscas_frango, image: 'pratos/iscas_frango.png' },
    { id: 'c6', name: 'items.c6.name', description: 'items.c6.desc', price: prices.couvert_iscas_mignon, image: 'pratos/iscas_mignon.png' },
    { id: 'c7', name: 'items.c7.name', description: 'items.c7.desc', price: prices.couvert_queijos, image: 'pratos/tabua_frios.png' },
    { id: 'c8', name: 'items.c8.name', description: 'items.c8.desc', price: prices.couvert_brie_folhado, image: 'pratos/brie_folhado.png' },
    { id: 'c9', name: 'items.c9.name', description: 'items.c9.desc', price: prices.couvert_burrata, image: 'pratos/burrata.png' },

    { section: 'sections.saladas' },
    { id: 's1', name: 'items.s1.name', description: 'items.s1.desc', price: prices.salada_mix_sem_brie, image: 'pratos/salada.png' },
    { id: 's2', name: 'items.s2.name', description: 'items.s2.desc', price: prices.salada_mix_com_brie, image: 'pratos/salada_brie.png' },

    { section: 'sections.sopas' },
    { id: 'sp1', name: 'items.sp1.name', description: 'items.sp1.desc', price: prices.sopa_canja, image: 'pratos/canja.png' },
    { id: 'sp2', name: 'items.sp2.name', description: 'items.sp2.desc', price: prices.sopa_capeletti, image: 'pratos/capeletti.png' },
    { id: 'sp3', name: 'items.sp3.name', description: 'items.sp3.desc', price: prices.sopa_creme_ervilha, image: 'pratos/creme_ervilha.png' },
    { id: 'sp4', name: 'items.sp4.name', description: 'items.sp4.desc', price: prices.sopa_creme_moranga, image: 'pratos/creme_moranga.png' },
    { id: 'sp5', name: 'items.sp5.name', description: 'items.sp5.desc', price: prices.sopa_creme_aipim, image: 'pratos/creme_aipim.png' },
  ],

  principal: [
    { section: 'sections.carnes' },
    { id: 'cn1', name: 'items.cn1.name', description: 'items.cn1.desc', price: prices.carne_ancho_massa, image: 'pratos/ancho_massa.png' },
    { id: 'cn2', name: 'items.cn2.name', description: 'items.cn2.desc', price: prices.carne_costela_12h, image: 'pratos/costela.png' },
    { id: 'cn3', name: 'items.cn3.name', description: 'items.cn3.desc', price: prices.carne_ancho_legumes, image: 'pratos/ancho_legumes.png' },
    { id: 'cn4', name: 'items.cn4.name', description: 'items.cn4.desc', price: prices.carne_tornedor_manteiga, image: 'pratos/tornedor.png' },
    { id: 'cn5', name: 'items.cn5.name', description: 'items.cn5.desc', price: prices.carne_parmegiana, image: 'pratos/parmegiana.png' },
    { id: 'cn6', name: 'items.cn6.name', description: 'items.cn6.desc', price: prices.carne_risoto_iscas, image: 'pratos/risoto_iscas.png' },
    { id: 'cn7', name: 'items.cn7.name', description: 'items.cn7.desc', price: prices.carne_escondidinho, image: 'pratos/escondidinho.png' },
    { id: 'cn8', name: 'items.cn8.name', description: 'items.cn8.desc', price: prices.carne_estrogonofe, image: 'pratos/estrogonofe.png' },
    { id: 'cn9', name: 'items.cn9.name', description: 'items.cn9.desc', price: prices.carne_nhoque_iscas, image: 'pratos/nhoque_iscas.png' },
    { id: 'cn10', name: 'items.cn10.name', description: 'items.cn10.desc', price: prices.carne_tornedor_roti, image: 'pratos/tornedor_roti.png' },
    { id: 'cn11', name: 'items.cn11.name', description: 'items.cn11.desc', price: prices.carne_alaminuta, image: 'pratos/alaminuta.png' },

    { section: 'sections.peixes' },
    { id: 'px1', name: 'items.px1.name', description: 'items.px1.desc', price: prices.peixe_polvo, image: 'pratos/polvo.png' },
    { id: 'px2', name: 'items.px2.name', description: 'items.px2.desc', price: prices.peixe_salmao_grelhado, image: 'pratos/salmao.png' },
    { id: 'px3', name: 'items.px3.name', description: 'items.px3.desc', price: prices.peixe_salmao_panko, image: 'pratos/salmao_panko.png' },
    { id: 'px4', name: 'items.px4.name', description: 'items.px4.desc', price: prices.peixe_truta, image: 'pratos/truta.png' },

    { section: 'sections.aves' },
    { id: 'av1', name: 'items.av1.name', description: 'items.av1.desc', price: prices.ave_frango_grelhado, image: 'pratos/frango_grelhado.png' },
    { id: 'av2', name: 'items.av2.name', description: 'items.av2.desc', price: prices.ave_parmegiana, image: 'pratos/frango_parmegiana.png' },
    { id: 'av3', name: 'items.av3.name', description: 'items.av3.desc', price: prices.ave_panko, image: 'pratos/frango_panko.png' },
    { id: 'av4', name: 'items.av4.name', description: 'items.av4.desc', price: prices.ave_estrogonofe, image: 'pratos/estrogonofe_frango.png' },
    { id: 'av5', name: 'items.av5.name', description: 'items.av5.desc', price: prices.ave_alaminuta, image: 'pratos/alaminuta_frango.png' },

    { section: 'sections.massas' },
    { id: 'ms1', name: 'items.ms1.name', description: 'items.ms1.desc', price: prices.massa_espaguete, image: 'pratos/espaguete.png' },
    { id: 'ms2', name: 'items.ms2.name', description: 'items.ms2.desc', price: prices.massa_nhoque_baroa, image: 'pratos/nhoque.png' },
    { id: 'ms3', name: 'items.ms3.name', description: 'items.ms3.desc', price: prices.risoto_brie_aspargos, image: 'pratos/risoto_aspargos.png' },
    { id: 'ms4', name: 'items.ms4.name', description: 'items.ms4.desc', price: prices.risoto_brie_formaggio, image: 'pratos/risoto_formaggio.png' },
  ],

  lanches: [
    { section: 'sections.burgers' },
    { id: 'ln1', name: 'items.ln1.name', description: 'items.ln1.desc', price: prices.lanche_burger_chef_fritas, image: 'pratos/burger_fritas.png' },
    { id: 'ln2', name: 'items.ln2.name', description: 'items.ln2.desc', price: prices.lanche_burger_chef, image: 'pratos/burger.png' },
    { id: 'ln3', name: 'items.ln3.name', description: 'items.ln3.desc', price: prices.lanche_club_sandwich, image: 'pratos/club_sandwich.png' },
    { id: 'ln4', name: 'items.ln4.name', description: 'items.ln4.desc', price: prices.lanche_sanduiche_integral, image: 'pratos/sanduiche_integral.png' },
    { id: 'ln5', name: 'items.ln5.name', description: 'items.ln5.desc', price: prices.lanche_misto_completo_fritas, image: 'pratos/misto_completo.png' },
    { id: 'ln6', name: 'items.ln6.name', description: 'items.ln6.desc', price: prices.lanche_misto_simples, image: 'pratos/misto_simples.png' },

    { section: 'sections.omeletes' },
    { id: 'om1', name: 'items.om1.name', description: 'items.om1.desc', price: prices.lanche_omelete_brie, image: 'pratos/omelete_brie.png' },
    { id: 'om2', name: 'items.om2.name', description: 'items.om2.desc', price: prices.lanche_omelete_mussarela, image: 'pratos/omelete_mussarela.png' },
    { id: 'om3', name: 'items.om3.name', description: 'items.om3.desc', price: prices.lanche_tapilete, image: 'pratos/tapilete.png' },
    { id: 'om4', name: 'items.om4.name', description: 'items.om4.desc', price: prices.lanche_tapioca_mussarela, image: 'pratos/tapioca_salgada.png' },
    { id: 'om5', name: 'items.om5.name', description: 'items.om5.desc', price: prices.lanche_tapioca_doce, image: 'pratos/tapioca_doce.png' },

    { section: 'sections.pizzas' },
    { id: 'pz1', name: 'items.pz1.name', description: 'items.pz1.desc', price: prices.pizza_mussarela, image: 'pratos/pizza_mussarela.png' },
    { id: 'pz2', name: 'items.pz2.name', description: 'items.pz2.desc', price: prices.pizza_calabresa, image: 'pratos/pizza_calabresa.png' },
    { id: 'pz3', name: 'items.pz3.name', description: 'items.pz3.desc', price: prices.pizza_marguerita, image: 'pratos/pizza_marguerita.png' },

    { section: 'sections.extras' },
    { id: 'ex1', name: 'items.ex1.name', description: 'items.ex1.desc', price: prices.lanche_fritas, image: 'pratos/porcao_fritas.png' },
    { id: 'ex2', name: 'items.ex2.name', description: 'items.ex2.desc', price: prices.lanche_chocolate_quente, image: 'pratos/chocolate_quente_lanche.png' },
  ],
